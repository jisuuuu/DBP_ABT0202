...
public class PostDAO {
	...
	// 글 생성
		...
		//메인에서 글 목록 불러오기
			public  List<Post> findPostListNine() throws SQLException {
				String sql = "SELECT * " + "FROM POST WHERE ROWNUM >= 1 AND ROWNUM <= 9 ORDER BY down_count DESC";
		        //String sql = "SELECT * " + "FROM POST WHERE ROWNUM >= 1 AND ROWNUM <= 9 ORDER BY upload_date DESC";
